[tsssolution-project2-b4b4] Operating Details
====================================

Generated On: 2024-10-17 16:48:05 UTC
...
.. important::
   ...
   **not be valid if your [tsssolution-project2-b4b4] container is NOT running**.

.. tip::
   You must have your [tsssolution-project2-b4b4] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=35851  \-\-env VIPERVIZPORT=9005  \-\-env GITUSERNAME='124457235-myseneca'  \-\-env DOCKERUSERNAME='kasunsam'  \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   kasunsam/tsssolution-project2-b4b4-amd64 (https://hub.docker.com/r/kasunsam/tsssolution-project2-b4b4-amd64)
...
.. important::
   docker run -d -p 59917:59917 -p 43121:43121 -p 44719:44719 \-\-env TSS=0 \-\-env SOLUTIONNAME=tsssolution-project2-b4b4 \-\-env SOLUTIONDAG=solution_preprocessing_dag-tsssolution-project2-b4b4 \-\-env GITUSERNAME=124457235-myseneca  \-\-env GITREPOURL=https://github.com/124457235-myseneca/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=59917  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=43121  \-\-env SOLUTIONVIPERVIZPORT=44719 \-\-env DOCKERUSERNAME='kasunsam'  \-\-env EXTERNALPORT=35851 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=9005 \-\-env MQTTUSERNAME='ksathugoda.ca@gmail.com' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  kasunsam/tsssolution-project2-b4b4-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=44719
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=59917
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - kasunsam/tsssolution-project2-b4b4-amd64
...
It can be accessed by entering: http://localhost:43121
...
.. important::
   http://localhost:44719/dashboard.html?topic=iot-preprocess,iot-preprocess2&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:44719/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:44719/<html file>
...
[tsssolution-project2-b4b4] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/124457235-myseneca/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/tsssolution-project2-b4b4
...
.. important::
   https://tsssolution-project2-b4b4.readthedocs.io
...
.. important::
   solution_preprocessing_dag-tsssolution-project2-b4b4
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=59917, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=46251, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41329, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34857, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=38319, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=44687, HPDEHOST=127.0.1.1, HPDEPORT=40169, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=38859

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1798-tsssolution-project2-b4b4,solution_preprocessing_dag-tsssolution-project2-b4b4, python-preprocess-6364-tsssolution-project2-b4b4,solution_preprocessing_dag-tsssolution-project2-b4b4, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
